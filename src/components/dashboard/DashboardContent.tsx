      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Link href="/tracking">
          <Card className="transition-colors hover:bg-muted/50">
            <CardHeader><CardTitle>Mes suivis</CardTitle><CardDescription>Suivre mes colis en temps réel</CardDescription></CardHeader>
          </Card>
        </Link>
        {user.isAdmin && (
          <Link href="/dashboard/admin">
            <Card className="transition-colors hover:bg-muted/50 border-primary/30">
              <CardHeader><CardTitle>Administration</CardTitle><CardDescription>Gérer les suivis, clients et trajectoires</CardDescription></CardHeader>
            </Card>
          </Link>
        )}
      </div>

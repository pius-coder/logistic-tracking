...
function ReviewCard({ review }: { review: ProductTestimonialView }) {
  return (
    <div className="group relative isolate flex flex-col gap-4 overflow-hidden rounded-[26px] border border-black/[0.07] bg-[#f7f6f2] p-6 ring-1 ring-white/80 shadow-[0_0_0_1px_rgba(255,255,255,0.42),0_1px_2px_rgba(15,23,42,0.05),0_18px_45px_-30px_rgba(15,23,42,0.30),inset_0_1px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(15,23,42,0.04)] transition-[transform,border-color,box-shadow] duration-300 ease-out hover:-translate-y-1 hover:border-black/[0.10] hover:shadow-[0_0_0_1px_rgba(255,255,255,0.55),0_2px_4px_rgba(15,23,42,0.06),0_28px_60px_-34px_rgba(15,23,42,0.40),inset_0_1px_0_rgba(255,255,255,1),inset_0_-1px_0_rgba(15,23,42,0.05)]">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-px rounded-[25px] shadow-[inset_1px_0_0_rgba(255,255,255,0.62),inset_-1px_0_0_rgba(15,23,42,0.025),inset_0_1px_0_rgba(255,255,255,0.82),inset_0_-1px_0_rgba(15,23,42,0.04)]"
      />
      <div className="relative z-10 flex items-start justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col gap-0.5">
            <span className="font-display text-[13px] font-bold leading-[18px] tracking-[-0.02em] text-[#0a192f]">
              {review.name}
            </span>
            <span className="font-display text-[11px] leading-[15px] tracking-[-0.01em] text-[#0a192f]/45">
              Avis vérifié
            </span>
          </div>
        </div>
      ...
      <p className="relative z-10 font-display text-[13px] leading-[1.65] tracking-[-0.01em] text-[#0a192f]/70">
        {review.advice}
      </p>
    </div>
  );
  ...
  return (
    <div className="flex w-full flex-col items-center bg-[#f5f4f0]">
      ...
      <section className="relative isolate flex min-h-[70vh] w-full overflow-hidden bg-[#06101f] min-[1200px]:min-h-[80vh]">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 -z-10 bg-[linear-gradient(180deg,rgba(3,10,23,0.88)_0%,rgba(5,17,37,0.67)_33%,rgba(7,26,54,0.28)_61%,rgba(3,10,20,0.08)_78%,rgba(3,8,16,0.30)_100%)]"
        />
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-[90px] -z-10 h-[520px] w-[1050px] -translate-x-1/2 rounded-full bg-[#2e6fb4]/[0.13] blur-[130px]"
        />
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(circle_at_center,transparent_25%,rgba(2,8,18,0.18)_72%,rgba(2,7,15,0.46)_100%)]"
        />
        <div
          aria-hidden="true"
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute inset-x-0 bottom-0 z-[2] h-36 bg-[linear-gradient(180deg,transparent_0%,rgba(3,9,18,0.18)_55%,rgba(3,9,18,0.42)_100%)]"
        />
          ...
          <div className="mt-6 flex flex-col gap-4 min-[810px]:max-w-[720px]">
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="inline-flex items-center gap-2 rounded-full border border-white/[0.11] bg-white/[0.055] px-3.5 py-1.5 font-display text-[11px] font-medium text-white/50 backdrop-blur-xl shadow-[0_1px_2px_rgba(0,0,0,0.18),inset_0_1px_0_rgba(255,255,255,0.08)]">
                ...
                <span>
                  {avgRating.toFixed(1)} ({product.testimonialCount} avis)
                </span>
              </div>
            </div>
      ...
      <section className="relative flex w-full flex-col items-center overflow-hidden bg-[#f5f4f0] px-5 py-[100px] min-[810px]:px-10 min-[810px]:py-[140px] min-[1200px]:py-[180px]">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-0 h-[520px] w-[900px] -translate-x-1/2 rounded-full bg-white/60 blur-[130px]"
        />
                ...
                <ul className="relative z-10 flex flex-col gap-4">
                  {product.features.map((feature) => (
                    <li key={feature} className="flex items-start gap-3">
                      ...
                      <span className="font-display text-[14px] leading-[20px] tracking-[-0.01em] text-[#0a192f]/68">
                        {feature}
                      </span>
                    </li>
                  ))}
      ...
      <section className="relative flex w-full flex-col items-center overflow-hidden bg-[#f5f5f1] px-5 py-[100px] min-[810px]:px-10 min-[810px]:py-[140px] min-[1200px]:py-[180px]">
        ...
        <div
          aria-hidden="true"
          className="pointer-events-none absolute left-1/2 top-0 h-[700px] w-[900px] -translate-x-1/2 rounded-full bg-white/50 blur-[120px]"
        />
          ...
          <div className="flex flex-col items-center gap-4 text-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="font-display text-[15px] font-medium tracking-[-0.01em] text-[#0a192f]/55">
                {avgRating.toFixed(1)} / 5 — {product.testimonialCount} avis
                vérifiés
              </span>
            </div>
          </div>
      ...
      <section className="relative flex w-full flex-col items-center overflow-hidden bg-[#f5f4f0] px-5 py-[100px] min-[810px]:px-10 min-[810px]:py-[140px] min-[1200px]:py-[180px]">
        ...
        <div className="relative z-10 flex w-full max-w-[1100px] flex-col items-center">
          <div className="relative isolate flex w-full flex-col items-center gap-10 overflow-hidden rounded-[36px] border border-white/[0.10] bg-[#081728] p-[30px] text-center ring-1 ring-black/40 shadow-[0_0_0_1px_rgba(255,255,255,0.045),0_2px_5px_rgba(2,8,18,0.28),0_35px_85px_-40px_rgba(3,10,22,0.80),inset_0_1px_0_rgba(255,255,255,0.11),inset_0_-1px_0_rgba(0,0,0,0.34)] min-[810px]:flex-row min-[810px]:justify-between min-[810px]:gap-14 min-[810px]:p-12 min-[810px]:text-left min-[1200px]:p-14">
            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_85%_10%,rgba(255,255,255,0.11),transparent_31%),radial-gradient(circle_at_8%_105%,rgba(49,91,139,0.22),transparent_38%)]"
            />
            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.035)_0%,transparent_34%,rgba(0,0,0,0.12)_100%)]"
            />
            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-px rounded-[35px] shadow-[inset_1px_0_0_rgba(255,255,255,0.035),inset_-1px_0_0_rgba(0,0,0,0.16),inset_0_1px_0_rgba(255,255,255,0.08),inset_0_-1px_0_rgba(0,0,0,0.22)]"
            />
            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-x-10 top-0 h-px bg-white/15"
            />
            ...
            <div className="relative z-10 flex max-w-[690px] flex-col items-center gap-5 min-[810px]:flex-1 min-[810px]:items-start">
              ...
              <p className="max-w-[620px] font-display text-[14px] leading-[1.7] tracking-[-0.01em] text-white/58 min-[810px]:text-[15px]">
                Contactez notre équipe commerciale pour un devis personnalisé et
                des conseils adaptés à votre projet d&apos;expédition.
              </p>
              <div className="mt-1 flex flex-col items-center gap-3 min-[810px]:items-start">
                ...
                <div className="flex flex-col items-center gap-2 min-[810px]:flex-row min-[810px]:gap-5">
                  <a
                    href="tel:+14122273484"
                    className="font-display text-[13px] text-white/50 transition-colors duration-200 hover:text-white"
                  >
                    +86 130 5916 2331{" "}
                  </a>
                  <span
            ...
            <div className="relative z-10 flex w-full shrink-0 flex-col items-center gap-3 min-[810px]:w-auto min-[810px]:items-end">
              ...
              <span className="font-display text-[11px] leading-[16px] tracking-[-0.005em] text-white/34">
